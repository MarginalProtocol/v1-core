...
def test_pool_adjust__updates_reserves_locked_when_add_margin_with_zero_for_one(
    pool_initialized_with_liquidity,
    callee,
    alice,
    sender,
...
def test_pool_adjust__updates_reserves_locked_when_add_margin_with_one_for_zero(
    pool_initialized_with_liquidity,
    callee,
    alice,
    sender,
...
def test_pool_adjust__updates_reserves_locked_when_remove_margin_with_zero_for_one(
    pool_initialized_with_liquidity,
    callee,
    alice,
    sender,
...
def test_pool_adjust__updates_reserves_locked_when_remove_margin_with_one_for_zero(
    pool_initialized_with_liquidity,
    callee,
    alice,
    sender,
